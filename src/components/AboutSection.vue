    ...
    <section class="text-white mt-18" id="about">
        ...
        <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 z-1">
            ...
            <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full" data-aos="flip-right">
                ...
                <p class="text-base lg:text-lg mt-8 py-8"> Saya Danish Fadlan Azam, Mahasiswa Semester 5 STMIK YMI Tegal
                    dengan prodi Teknik Informatika. Saya berumur 20 tahun. Saya tertarik di bidang Informatika. Saya
                    ingin berkarir di web developer
                </p>
            </div>
        </div>
    </section>
