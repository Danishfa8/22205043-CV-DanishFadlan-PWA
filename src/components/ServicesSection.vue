...
const services = ref([
    {
        ...
        description: 'Membuat website modern, responsif, dan dinamis dengan teknologi terbaru. Fokus pada performa, keamanan, dan pengalaman pengguna yang optimal.'
    },
    {
        id: 2,
        ...
        description: 'Mengembangkan aplikasi mobile yang intuitif dan cepat untuk platform Android dan iOS, memastikan kinerja yang stabil serta tampilan menarik untuk pengalaman pengguna yang maksimal.'
    },
    {
        id: 3,
        icon: 'https://img.icons8.com/ios-filled/100/ffffff/windows10-personalization.png',
        name: 'Graphic Design',
        description: 'Desain grafis yang kreatif dan profesional untuk kebutuhan branding, pemasaran, dan visual lainnya, mencakup logo, poster, dan media sosial yang menarik perhatian.'
    }
]);
